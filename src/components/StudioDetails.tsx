      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg max-w-4xl w-full my-8 max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-6">
            ...
            {(() => {
              console.log('Studio images:', studio.images);
              return null;
            })()}
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {studio.images.map((image, index) => (
                    <img
                      ...
                      className="w-full h-auto max-h-96 object-contain rounded-lg shadow-md hover:shadow-xl transition-shadow duration-200 bg-gray-100"
                    />
                  ))}
                </div>
              </div>
            ...
            {studio.name === 'Olive Garden Guesthouse' ? (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="flex items-center gap-2 text-gray-700">
                  ...
                  <span className="font-medium">7 {language === 'bg' ? 'двойни легла' : language === 'en' ? 'double beds' : language === 'ru' ? 'двуспальные кровати' : language === 'sr' ? 'брачна кревета' : language === 'el' ? 'διπλά κρεβάτια' : language === 'ro' ? 'paturi duble' : language === 'mk' ? 'брачни кревети' : 'double beds'}</span>
                </div>
                <div className="flex items-center gap-2 text-gray-700">
                  <svg className="w-6 h-6 text-gray-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="font-medium">2 {language === 'bg' ? 'разтегателни дивана' : language === 'en' ? 'sofa beds' : language === 'ru' ? 'раскладных дивана' : language === 'sr' ? 'раскладива кауча' : language === 'el' ? 'καναπέδες-κρεβάτι' : language === 'ro' ? 'canapele extensibile' : language === 'mk' ? 'разложливи дивани' : 'sofa beds'}</span>
                </div>
                <div className="flex items-center gap-2 text-gray-700">
                  <Bath className="text-gray-700" size={24} />
                  <span className="font-medium">5 {language === 'bg' ? 'бани' : language === 'en' ? 'bathrooms' : language === 'ru' ? 'ванные комнаты' : language === 'sr' ? 'купатила' : language === 'el' ? 'μπάνια' : language === 'ro' ? 'băi' : language === 'mk' ? 'бањи' : 'bathrooms'}</span>
                </div>
                <div className="flex items-center gap-2 text-gray-700">
                  <svg className="w-6 h-6 text-gray-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="font-medium">14 + 4 {language === 'bg' ? 'гости' : language === 'en' ? 'guests' : language === 'ru' ? 'гостей' : language === 'sr' ? 'гостију' : language === 'el' ? 'επισκέπτες' : language === 'ro' ? 'oaspeți' : language === 'mk' ? 'гости' : 'guests'}</span>
                </div>
              </div>
            ) : studio.name === 'Апартамент №1' || studio.name === 'Апартамент №4' ? (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="flex items-center gap-2 text-gray-700">
                  <svg className="w-6 h-6 text-gray-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="2" y="11" width="20" height="9" rx="1" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="flex items-center gap-2 text-gray-700">
                  ...
                  <span className="font-medium">4 {language === 'bg' ? 'гости' : language === 'en' ? 'guests' : language === 'ru' ? 'гостей' : language === 'sr' ? 'гостију' : language === 'el' ? 'επισκέπτες' : language === 'ro' ? 'oaspeți' : language === 'mk' ? 'гости' : 'guests'}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="flex items-center gap-2 text-gray-700">
                  ...
                  <span className="font-medium">3 {language === 'bg' ? 'гости' : language === 'en' ? 'guests' : language === 'ru' ? 'гостей' : language === 'sr' ? 'гостију' : language === 'el' ? 'επισκέπτες' : language === 'ro' ? 'oaspeți' : language === 'mk' ? 'гости' : 'guests'}</span>
                </div>
              </div>
            ) : (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="border-t pt-6">
              <div className="mb-6">
                ...
                {studio.name === 'Olive Garden Guesthouse' || studio.name === 'Апартамент №1' || studio.name === 'Апартамент №4' || studio.name === 'Студио №2' || studio.name === 'Студио №3' || studio.name === 'Студио №5' || studio.name === 'Студио №6' ? (
